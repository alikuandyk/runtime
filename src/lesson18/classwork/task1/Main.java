...
//        System.out.println(builder);
        ...
        for (int i = 0; i < users.length; i++) {
            builder.append(String.format("{name=%s, age=%d, posts=[{title=%s, postedAt=%s}]} ", users[i].getName(), users[i].getAge(),
                            users[i].getPosts()[0].getTitle(), users[i].getPosts()[0].getPostedAt()))
